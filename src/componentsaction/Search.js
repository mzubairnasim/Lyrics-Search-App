...
export default function Search() {
    ...
    const api=`https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.search?&page_size=5&q_track=${userInput}&apikey=6809450facf7b1b9e5ab776a6ac20587`
